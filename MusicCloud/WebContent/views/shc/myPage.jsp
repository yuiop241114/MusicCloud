    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="main-1">
                ...
                <b>유저 이름</b>
                <br>
                <b style="color: gray;">유저 이메일</b>

                <br><br>
                
                <br>
                <b style="color: gray;">회원탈퇴</b>
                <br>
                <button id="infoBtn" style="color: gray; font-weight: bold; background: none; border: none; cursor: pointer;">내정보</button>
                <br>
                <button id="friendListBtn" style="color: gray; font-weight: bold; background: none; border: none; cursor: pointer;">친구리스트</button>
                <br>
                <b style="color: gray;">로그아웃</b>
