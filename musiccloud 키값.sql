...
CREATE TABLE MUSIC_COMMENT 
    ...
    , COMMENT_CONTENT VARCHAR2(600 CHAR) NOT NULL 
    , COMMENT_LIKE NUMBER                  
    , COMMENT_DISLIKE NUMBER              
    , COMMENT_DATE DATE DEFAULT SYSDATE                    
    );
    
CREATE TABLE RECENT_MUSIC
    (
      MEMBER_NO NUMBER NOT NULL
    , MUSIC_NO NUMBER NOT NULL
...
CREATE TABLE BOARD_COMMENT
     ...
     , COMMENT_ENROLL_DATE DATE DEFAULT SYSDATE
...
COMMENT ON COLUMN MUSIC_COMMENT.COMMENT_CONTENT IS '댓글 내용';
